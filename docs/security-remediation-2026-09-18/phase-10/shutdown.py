...
root=pathlib.Path('/Users/mahdi/Documents/work/ioiv');e=root/'docs/security-remediation-2026-09-18/phase-10';records=[json.loads((e/n).read_text()) for n in ['environment.json']];result={'containers':[],'recordedPids':{},'ports':{}};ports=set();pids=set()
for p in e.glob('*.log'):
