...
root=pathlib.Path('/Users/mahdi/Documents/work/ioiv'); e=root/'docs/security-remediation-2026-09-18/phase-10'; info=json.loads((e/'environment.json').read_text()); src=pathlib.Path(info['source']); env=json.loads((pathlib.Path(info['run'])/'env.json').read_text())
if sys.argv[1]=='sync':
