...
root=pathlib.Path.cwd(); e=root/'docs/security-remediation-2026-09-18/phase-14'; info=json.loads((e/'environment.json').read_text()); env=json.loads((pathlib.Path(info['run'])/'env.json').read_text()); src=pathlib.Path(info['source'])
