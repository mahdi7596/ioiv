...
const statusGuidance: Record<string, string> = {
  DRAFT: "پرونده هنوز ارسال نشده است. می‌توانید مدارک را کامل کنید، اما پرداخت برای پرونده‌های پرداخت‌نشده در حال حاضر غیرفعال است.",
  PENDING_PAYMENT: "پرونده کامل شده و منتظر نتیجه پرداخت از درگاه است. شروع یا تلاش دوباره برای پرداخت در حال حاضر غیرفعال است.",
